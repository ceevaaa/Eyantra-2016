...
**************************************************************************
"""
# detectCellVal detects the numbers/operators,
...
def detectCellVal(img_rgb,grid_map):
    ...
    template = [
                    cv2.imread('digits/0.jpg',0), cv2.imread('digits/1.jpg',0),
                    cv2.imread('digits/2.jpg',0), cv2.imread('digits/3.jpg',0),
                    cv2.imread('digits/4.jpg',0), cv2.imread('digits/5.jpg',0),
                    cv2.imread('digits/6.jpg',0), cv2.imread('digits/7.jpg',0),
                    cv2.imread('digits/8.jpg',0), cv2.imread('digits/9.jpg',0),
                    cv2.imread('digits/minus.jpg',0), cv2.imread('digits/plus.jpg',0)
                ]
